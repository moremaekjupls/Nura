 ...
 * Tailwind's layer order, but a later `bg-white/45` utility always does.
 *
...
export const GLASS_CARD =
  `bg-white/45 backdrop-blur-xl backdrop-saturate-150 border-white/40 ${SHINE}`;

export const GLASS_SURFACE =
  `bg-white/75 backdrop-blur-xl backdrop-saturate-150 border-white/50 ${SHINE}`;

export const GLASS_BAR =
  "bg-white/55 backdrop-blur-xl backdrop-saturate-150 border-white/30";
