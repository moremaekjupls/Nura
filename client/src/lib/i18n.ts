...
const ru = {
  ...
  'profile.defaultNote': 'Стандартная норма — заполните профиль, чтобы посчитать свою',
  ...
  'profile.years': '{n} лет',
  'profile.emailSection': 'Вход по email', 'profile.emailHint': 'Чтобы открывать Nura и в браузере, и в Telegram',
  'profile.linkExisting': 'У меня уже есть аккаунт', 'profile.linkHint': 'Записи из Telegram перенесутся в этот аккаунт',
  'profile.addEmail': 'Добавить email и пароль', 'profile.linked': 'Аккаунты объединены', 'profile.emailAdded': 'Email добавлен',
...
const uz: Record<Key, string> = {
  ...
  'profile.defaultNote': 'Standart meʼyor — oʻzingiznikini hisoblash uchun profilni toʻldiring',
  ...
  'profile.emailSection': 'Email orqali kirish', 'profile.emailHint': 'Nurani brauzerda ham, Telegramda ham ochish uchun',
  'profile.linkExisting': 'Menda allaqachon hisob bor', 'profile.linkHint': 'Telegramdagi yozuvlar shu hisobga koʻchiriladi',
  'profile.addEmail': 'Email va parol qoʻshish', 'profile.linked': 'Hisoblar birlashtirildi', 'profile.emailAdded': 'Email qoʻshildi',
