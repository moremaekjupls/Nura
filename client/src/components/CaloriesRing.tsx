...
export function CaloriesRing({ consumed, goal, isOverGoal }: CaloriesRingProps) {
  ...
  return (
    <Card className="border border-white/40 bg-white/45 backdrop-blur-xl backdrop-saturate-150 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.55),0_8px_24px_-8px_rgba(0,0,0,0.35)] p-6 sm:p-8 animate-fade-in-up">
